      ...
      <div className="grid lg:grid-cols-2">
        ...
        <div className="flex items-center py-20 sm:py-24 lg:py-28">
          <Container width="full" className="max-w-[42rem] lg:pr-16">
            ...
            <Reveal delay={0.06}>
              <h2 className="mt-5 font-display text-[clamp(2rem,4.2vw,3.25rem)] font-light leading-[1.05] tracking-tight text-navy-900">
            ...
            <Reveal delay={0.12}>
              <p className="mt-6 text-[1.0625rem] leading-relaxed text-navy-900/70">
            ...
            <Reveal delay={0.16}>
              <p className="mt-4 text-[1.0625rem] leading-relaxed text-navy-900/70">
            ...
            <Reveal delay={0.2}>
              <dl className="mt-10 grid grid-cols-3 gap-6 border-t border-navy-900/[0.08] pt-9">
                <div>
