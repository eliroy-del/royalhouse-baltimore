        ...
        {options.map((option) => {
          ...
          return (
            <button
              ...
              className={cn(
                "min-h-11 rounded-full border px-4 py-2 text-[0.8125rem] font-medium transition-[background-color,border-color,color,transform] duration-200",
                "active:scale-[0.97]",
                isActive
                  ? "border-navy-900 bg-navy-900 text-white shadow-subtle"
