...
export const siteConfig = {
  ...
  description:
    "Royalhouse Baltimore is a Spirit-filled church in Baltimore, Maryland. Join us Tuesdays at 7 PM. Sunday evenings begin November 2026; Sunday morning launch May 2027 at 5411 Old Frederick Rd, Ste 11-12. You belong here.",
  url: siteUrl,
  locale: "en_US",
  ...
  keywords: [
    ...
    "church in Baltimore",
    "churches in Baltimore MD",
    "Christian church Baltimore",
    "Baltimore worship service",
    "church service Baltimore",
  ],
