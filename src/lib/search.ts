...
const pages: { title: string; description: string; href: string; icon: IconName; keywords: string }[] =
  [
    ...
    {
      title: "Connect",
      description: "Phone, email, social and a form to take a next step.",
      href: "/contact",
      icon: "users",
      keywords: "connect contact groups serve next steps new here",
    },
    {
      title: "Who We Are",
    ...
    },
    {
      ...
      icon: "users",
      keywords: "leadership pastor richieo lead pastor",
    },
    {
      title: "Contact",
